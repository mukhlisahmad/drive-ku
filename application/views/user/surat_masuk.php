...
<div class="container">
			<div class="row">
				<div class="col-md">
					<div class="upload">
					<h1>surat masuk</h1>
						<?=form_open_multipart('User/upload_suratmasuk');?>
										...
										<td>
											<div class="dropdown">
												...
												<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
													<li><a class="dropdown-item" href="<?=base_url();?>User/download_suratmasuk/<?=$f['id_surat'];?>">Download</a></li>
													<li><a class="dropdown-item" href="<?=base_url();?>User/delete_suratmasuk/<?=$f['id_surat'];?>">Delet</a></li>
												</ul>
											</div>
										</td>
