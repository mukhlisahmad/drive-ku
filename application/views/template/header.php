...
<html
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?=base_url('assets/')?>img/fd.png" />
    ...
    <link rel="stylesheet" href="<?=base_url('assets/')?>vendor/libs/bootstrap-maxlength/bootstrap-maxlength.css" />
